        ...
        <div class="d-date-time-time-content">
                <div ref="scrollHours" class="scroll hours-wrap">
                        <ul class="scroll-wrapper">
                                <li v-for="(item, index) in hoursArr" :key="index" class="hours-item" @click="select(item, index, 'hour')">
                                        <!--选中-->
                                        <div v-if="item.isSelect" class="selected" :style="{color: color}">{{item.value}}
                                        </div>
                                        <!--没有选中-->
                ...
                <div ref="scrollMinutes" class="scroll minutes-wrap">
                        <ul class="scroll-wrapper">
                                <li v-for="(item, index) in minutesArr" :key="index" class="minutes-item" :class="{selected: item.isSelect}" @click="select(item, index, 'minute')">
                                        <!--选中-->
                                        <div v-if="item.isSelect" class="selected" :style="{color: color}">{{item.value}}
                                        </div>
                                        <!--没有选中-->
