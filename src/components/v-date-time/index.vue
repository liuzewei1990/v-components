                                ...
                                <div class="calendar-move" v-if="isShow">
                                        <div class="d-date-time-contain" @click.stop v-if="isShow">
                                                <div class="d-date-time-header" :style="{background: color}">
                                                        <div class="d-date-time-year" v-if="type === 'dateTime' || type === 'year' || type ==='date'" :class="{left: textAlign === 'left', center: textAlign === 'center', right: textAlign === 'right'}" @click="selectYear">{{year}}
                                                        </div>
                                                        <div class="d-date-time-value" :class="{left: textAlign === 'left', center: textAlign === 'center', right: textAlign === 'right'}">
                                                                {{showDate}}
                                                        </div>
                                                </div>
                                                <div class="d-date-time-content">
                                                        <div class="d-date-time-months" v-if="status === 'day'">
                                                                <div class="up-page" @click="changeMonth('last')">
                                                                        <b class="left"><i class="left-arrow1"></i><i class="left-arrow2"></i></b>
                                                                </div>
                                                                <div class="d-date-time-month" @click="selectMonth">{{month}}月</div>
                                                                <div class="next-page" @click="changeMonth('next')">
                                                        ...
                                                        <div class="d-date-time-years-wrap" v-if="status === 'year'">
                                                                <i v-if="type !== 'year' " class="d-data-time-close" @click="close"></i>
                                                                <d-date-time-pick-year :data="yearArr" :color="color" @click="chooseYear"></d-date-time-pick-year>
                                                        </div>
                                                        ...
                                                        <div class="d-date-time-month-wrap" v-if="status === 'month'">
                                                                <i v-if="type !=='month'" class="d-data-time-close" @click="close"></i>
                                                                <div class="d-data-time-months">
                                                                        <div v-for="(item, index) in monthArr" :key="`month-${index}`">
                                                                                <div @click="chooseMonth(index)">
                                                                                        <d-date-time-card :color="color" :data="item" type="month"></d-date-time-card>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                        </div>
                                                        ...
                                                        <div class="d-date-time-time-wrap" v-if="status === 'time'">
                                                                <i v-if="type !=='time'" class="d-data-time-close" @click="close"></i>
                                                                <d-date-time-pick-hm :hoursArr="hoursArr" :minutesArr="minutesArr" :color="color" @click="changeTime"></d-date-time-pick-hm>
                                                        </div>
                                                </div>
...
.d-date-time {
        ...
        .d-date-time-content {
                ...
                .d-data-time-close:before,
                .d-data-time-close:after {
                        content: "";
                        position: absolute;
                        top: 50%;
                        width: 30px;
